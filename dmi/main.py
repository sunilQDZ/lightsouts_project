...
import uvicorn
from dmi.core.database import init_db_pool, close_db_pool, load_categories_from_db
from dmi.services.anthropic_client import close_anthropic_client
from dmi.api.routes import router
...
app = FastAPI(
    ...
    description="FastAPI-based AI system that analyzes customer comments (Voice of Customer - VOC) using Anthropic Claude for DMI DMI.",
    version="1.0.0",
    lifespan=lifespan,
    docs_url=None,
    redoc_url=None,
