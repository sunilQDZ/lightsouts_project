...
from dmi.models.schemas import InferenceRequest, InsightResponse, InsightPredictionItem
from dmi.core.security import require_api_key
from dmi.services.insight_service import generate_insight
from dmi.core.config import settings
from dmi.services.batch_processor import run_batch_pipeline
...
async def start_daily_analysis(background_tasks: BackgroundTasks):
    ...
    from DMI DMI survey data (e.g. App Performance, Transactions),
    ...
    return {
        "status": "success",
        "message": "Production DMI DMI daily detractor analysis started in background. Processing all day-1 detractors into AI_Analyzed and voc_alerts."
    }
...
async def clear_cache():
    ...
    from dmi.services.insight_service import CACHE_FILE as cache_file
