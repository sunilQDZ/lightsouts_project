...
from npci.services.heuristics import (
...
from npci.core.database import load_categories_from_db
from npci.services.anthropic_client import (
    call_anthropic_llm
)
import json
import os
...
MAX_CACHE_SIZE = 5000
CACHE_FILE = os.path.join(os.path.dirname(os.path.dirname(__file__)), "npci_inference_cache.json")
