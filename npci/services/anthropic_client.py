...
from npci.services.heuristics import similarity_score, clean_for_match, ensure_string

from npci.core.config import settings
from npci.services.heuristics import SENTIMENTS, PRIORITIES
...
def build_system_prompt() -> str:
    ...
    prompt_text = f"""
You are an expert VOC (Voice of Customer) analyst for NPCI and digital payments.
...
4. If the comment is NOT related to payments/NPCI (e.g., complaining about a completely unrelated delivery issue), or is purely gibberish (e.g., "hjksdf"), you MUST assign the category "Generic".
