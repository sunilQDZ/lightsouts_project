...
import uvicorn
from npci.core.database import init_db_pool, close_db_pool, load_categories_from_db
from npci.services.anthropic_client import close_anthropic_client
from npci.api.routes import router
...
from npci.core.security import require_docs_web_lock

app = FastAPI(
    title="CX Anthropic AI API",
    description="FastAPI-based AI system that analyzes customer comments (Voice of Customer - VOC) using Anthropic Claude for NPCI BHIM.",
    version="1.0.0",
    lifespan=lifespan,
    docs_url=None,
    redoc_url=None,
