...
from lt.models.schemas import InferenceRequest, InsightResponse, InsightPredictionItem
from lt.core.security import require_api_key
...
async def start_daily_analysis(background_tasks: BackgroundTasks):
    ...
    from all 6 survey tables (Two Wheeler, Personal, Home, Farm, SME, Micro Loans),
    ...
    return {
        "status": "success",
        "message": "Production daily detractor analysis started in background. Processing all day-1 detractors into AI_Analyzed and voc_alerts."
    }
...
async def clear_cache():
    ...
    from lt.services.insight_service import CACHE_FILE_PATH as cache_file
